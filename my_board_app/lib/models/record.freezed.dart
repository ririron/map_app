...
abstract class $RecordCopyWith<$Res> {
  ...
  @useResult
  $Res call({int userId, DateTime date, String task, int sp});
}
...
class _$RecordImpl implements _Record {
  ...
  @override
  String toString() {
    return 'Record(userId: $userId, date: $date, task: $task, sp: $sp)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userId, date, task, sp);
...
abstract class _Record implements Record {
  const factory _Record(
      ...
      required final int sp}) = _$RecordImpl;
